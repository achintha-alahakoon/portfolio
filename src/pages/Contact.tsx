...
export function Contact() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const scriptUrl =
        "https://script.google.com/macros/s/AKfycbzOB8u_2obnkfvDyD-XMlklLO1mxy4P2fSeZAhvORBHZUqs0jOXPSffu4TFuY4WtBuPmg/exec";
  ...
  return (
    <SectionWrapper id="contact">
      <div className="bg-gradient-to-b from-transparent to-slate-900/20 max-w-5xl mx-auto">
        <motion.p
          className="text-cyan-400 text-sm uppercase tracking-[0.3em] mb-4 font-medium text-center"
          initial={{
            opacity: 0,
            y: 10,
          }}
        ...
        <motion.div
          className="mx-auto mt-5 mb-20 h-px bg-gradient-to-r from-transparent via-cyan-400 to-transparent"
